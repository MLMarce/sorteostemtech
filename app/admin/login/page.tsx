...
import { Lock, ShieldCheck, ArrowRight, UserPlus, Mail, User, Sparkles, Eye, EyeOff } from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full bg-[#06070A] border border-slate-700 rounded-xl pl-4 pr-10 py-2.5 text-sm text-white font-mono focus:outline-none focus:border-violet-400 transition-colors"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
